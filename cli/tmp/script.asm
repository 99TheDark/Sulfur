...
; %bb.0:                                ; %entry
	...
	.cfi_endproc
                                        ; -- End function
	.globl	_countRefMsg                    ; -- Begin function countRefMsg
	.p2align	2
_countRefMsg:                           ; @countRefMsg
	.cfi_startproc
; %bb.0:                                ; %entry
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]             ; 16-byte Folded Spill
...
LBB8_2:                                 ; %if.then
	...
	.cfi_endproc
                                        ; -- End function
	.globl	_freeRefMsg                     ; -- Begin function freeRefMsg
	.p2align	2
_freeRefMsg:                            ; @freeRefMsg
	.cfi_startproc
; %bb.0:                                ; %entry
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]             ; 16-byte Folded Spill
...
LBB22_4:                                ; %if.then
	...
	.cfi_endproc
                                        ; -- End function
	.globl	_freeAutoMsg                    ; -- Begin function freeAutoMsg
	.p2align	2
_freeAutoMsg:                           ; @freeAutoMsg
	.cfi_startproc
; %bb.0:                                ; %entry
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]             ; 16-byte Folded Spill
...
; %bb.0:                                ; %entry
	...
	.cfi_endproc
                                        ; -- End function
	.globl	"_.free:string"                 ; -- Begin function .free:string
	.p2align	2
"_.free:string":                        ; @".free:string"
	.cfi_startproc
; %bb.0:                                ; %entry
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]             ; 16-byte Folded Spill
...
LBB32_5:                                ; %if.then1
Lloh30:
	adrp	x9, l_.strZero.13@PAGE
	mov	w8, #1
Lloh31:
	add	x9, x9, l_.strZero.13@PAGEOFF
	str	w8, [sp, #32]
	str	x9, [sp, #40]
LBB32_6:                                ; %exit
	ldr	x0, [sp, #16]
