...
@.str0.2 = private unnamed_addr constant [5 x i8] c"Hello", align 1
...
define void @main() {
entry:
  %0 = getelementptr inbounds [5 x i8], [5 x i8]* @.str0.2, i32 0, i32 0
  ...
  %6 = getelementptr inbounds [5 x i8], [5 x i8]* @.str1.3, i32 0, i32 0
  ...
  store %type.string %11, %type.string* %x, align 8
  %12 = load %type.string, %type.string* %x, align 8
