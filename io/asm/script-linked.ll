...
@.str0.1 = private unnamed_addr constant [1 x i8] c" ", align 1
@.str1 = private unnamed_addr constant [0 x i8] zeroinitializer, align 1
...
for.body0:                                        ; preds = %for.cond0
  ...
  %4 = getelementptr inbounds [1 x i8], [1 x i8]* @.str0.1, i32 0, i32 0
