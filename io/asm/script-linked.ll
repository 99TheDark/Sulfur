...
@.str0.1 = private unnamed_addr constant [1 x i32] [i32 60], align 4
...
while.cond1:                                      ; preds = %while.body1, %entry
...
while.cond2:                                      ; preds = %while.body2, %while.cond1
...
define void @main() {
entry:
  %0 = getelementptr inbounds [1 x i32], [1 x i32]* @.str0.1, i32 0, i32 0
