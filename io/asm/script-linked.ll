...
@.str1.3 = private unnamed_addr constant [2 x i8] c", ", align 1
...
entry:
  %.ret = alloca %type.string, align 8
  %2 = getelementptr inbounds [2 x i8], [2 x i8]* @.str1.3, i32 0, i32 0
...
entry:
  %1 = getelementptr inbounds [1 x i8], [1 x i8]* @.str0.2, i32 0, i32 0
  ...
  %str2 = alloca %type.string, align 8
  store %type.string %7, %type.string* %str2, align 8
  %8 = load %type.string, %type.string* %str2, align 8
