...
exit:                                             ; preds = %while.end3
  ret void

while.cond0:                                      ; preds = %if.end2, %if.then2, %entry
...
while.end0:                                       ; preds = %if.then1, %while.cond0
  %2 = getelementptr inbounds [0 x i8], [0 x i8]* @.str1.1, i32 0, i32 0
...
if.then1:                                         ; preds = %while.body0
  br label %while.end0

if.end1:                                          ; preds = %while.body0
...
while.cond3:                                      ; preds = %if.end5, %if.then5
  br i1 true, label %while.body3, label %while.end3

while.body3:                                      ; preds = %while.cond3, %while.end0
  %24 = load i32, i32* %j, align 4
  %25 = icmp sgt i32 %24, 30
  br i1 %25, label %if.then4, label %if.end4

while.end3:                                       ; preds = %if.then4, %while.cond3
  %26 = getelementptr inbounds [0 x i8], [0 x i8]* @.str1.1, i32 0, i32 0
...
if.then4:                                         ; preds = %while.body3
  br label %while.end3

if.end4:                                          ; preds = %while.body3
...
if.end5:                                          ; preds = %if.end4
  ...
  %39 = getelementptr inbounds [1 x i8], [1 x i8]* @.str0.2, i32 0, i32 0
