...
define void @main() {
entry:
  %0 = getelementptr inbounds [4 x i8], [4 x i8]* @.str1.1, i32 0, i32 0
  ...
  store %type.string %5, %type.string* %firstName, align 8
  ...
  store %type.string %11, %type.string* %lastName, align 8
