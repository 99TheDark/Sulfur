...
if.then1:                                         ; preds = %for.body0
  %13 = getelementptr inbounds [24 x i8], [24 x i8]* @.str0.1, i32 0, i32 0
  ...
  %18 = load %type.string*, %type.string** %age, align 8
...
if.else1:                                         ; preds = %for.body0
  ...
  %31 = load %type.string*, %type.string** %age, align 8
