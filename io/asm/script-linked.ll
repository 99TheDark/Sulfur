...
@.str0.1 = private unnamed_addr constant [8 x i8] c"I am in ", align 1
@.str1.2 = private unnamed_addr constant [15 x i8] c"th grade, it's ", align 1
...
define void @main() {
entry:
  %0 = getelementptr inbounds [8 x i8], [8 x i8]* @.str0.1, i32 0, i32 0
  %1 = alloca %type.string, align 8
  %2 = getelementptr inbounds %type.string, %type.string* %1, i32 0, i32 0
  ...
  %8 = getelementptr inbounds [15 x i8], [15 x i8]* @.str1.2, i32 0, i32 0
  ...
  store %type.string %16, %type.string* %x, align 8
