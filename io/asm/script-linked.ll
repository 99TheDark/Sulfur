...
entry:
  ...
  %11 = load %type.string*, %type.string** %lastName, align 8
  ...
  %abc = alloca float, align 4
  store float %20, float* %abc, align 4
  %21 = load float, float* %abc, align 4
  %22 = fadd float 0x400CCCCCC0000000, %21
  %def = alloca float, align 4
  store float %22, float* %def, align 4
  ret void
}
